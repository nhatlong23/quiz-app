                                ...
                                <div class="position-relative row form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="student_code" id="student_code"
                                            placeholder="Nhập mã thí sinh vào đây!!" type="text" class="form-control"
                                ...
                                <div class="position-relative row form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="phone" id="phone"
                                            placeholder="Nhập số điện thoại thí sinh vào đây!!" type="phone"
                                            class="form-control" value="{{ isset($students) ? $students->phone : '' }}">
                                    </div>
                                </div>
                                <div class="position-relative row form-group">
