...
@section('content')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="{{ route('questions.destroy', $list->id) }}"
                                            ...
                                            @method('DELETE')
                                            @can('questions.edit')
                                                <a href="{{ route('questions.edit', $list->id) }}" class="btn btn-secondary">
    ...
    @push('model')
        <div class="modal fade quick_view" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
