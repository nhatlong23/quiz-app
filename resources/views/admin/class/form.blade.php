                        ...
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                ...
                                <div class="position-relative row form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="name" id="name" placeholder="Nhập tên lớp vào đây!!"
                                    ...
                                    <div class="col-sm-10">
                                        <select name="block_id" class="form-control">
                                            @foreach ($blocks_name as $block_name)
                                                <option value="{{ $block_name->id }}" {{ isset($class) && $class->block_id == $block_name->id ? 'selected' : '' }}>
                                                    {{ $block_name->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="position-relative row form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="status" class="form-control">
                                            <option value="1"
                                                {{ isset($class) && $class->status == 1 ? 'selected' : '' }}>Hiển thị lớp
                                                học</option>
                                            <option value="0"
